...
const About = ({ name, aboutData }) => {
  const astrologerImageUrl = "Ajay.jpg"; 
  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden">
      {/* Background with Spiritual Glow and Om/Ram Pattern */}
      <div className="absolute inset-0 z-0 bg-slate-900">
        {/* Dark overlay */}
        <div className="absolute inset-0 bg-black opacity-30"></div>
        
        {/* Subtle Om/Ram Pattern Background - Image needed here */}
        <div 
          className="absolute inset-0 opacity-10" // Reduced opacity for subtlety
          style={{ 
            backgroundImage: "url('ram.png')", // **Update this path to your generated image**
            backgroundSize: 'cover', 
            backgroundRepeat: 'repeat', // Use 'repeat' if the pattern is designed to tile
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-amber-500 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-pulse-slow"></div>
      </div>
